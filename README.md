...
# This Project Could generate a RPG Maker MV ROM File in zip format or rar format or 7z format, For Testing "RPGEmu for RPG Maker MV" Only, short name is "RPGEmu"
...
# 7Z DOWNLoad ROM FILE IS [demo.7z](https://github.com/gzqyl/rpgemu/releases/download/test/demo.7z)
[demo.7z](https://github.com/gzqyl/rpgemu/releases/download/test/demo.7z) © 2025 by [Ping Yan](https://www.soulyin.com/) is licensed under Creative Commons Attribution-NoDerivatives 4.0 International
...
or download the [demo.7z](https://github.com/gzqyl/rpgemu/releases/download/test/demo.7z)\
second, after you download it from safari, it will be located in your Files App\
third, open RPGEmu, select file, select the zip or .rar or .7z\
...
The difference is RPGEmu will let you play RPG Maker MV games or RPG Maker MZ games.
